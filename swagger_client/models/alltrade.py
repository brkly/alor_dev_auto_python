...
class Alltrade(object):
    ...
    def __init__(self, id=None, orderno=None, symbol=None, qty=None, price=None, time=None, timestamp=None, side=None, oi=None, existing=None):  # noqa: E501
        """Alltrade - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._orderno = None
        self._symbol = None
        self._qty = None
    ...
    @property
    def id(self):
        """Gets the id of this Alltrade.  # noqa: E501

        Уникальный идентификатор.  # noqa: E501

        :return: The id of this Alltrade.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this Alltrade.

        Уникальный идентификатор.  # noqa: E501

        :param id: The id of this Alltrade.  # noqa: E501
        :type: int
        """
    ...
    @property
    def orderno(self):
        """Gets the orderno of this Alltrade.  # noqa: E501

        Идентификатор заявки  # noqa: E501

        :return: The orderno of this Alltrade.  # noqa: E501
        :rtype: int
        """
    ...
    def orderno(self, orderno):
        """Sets the orderno of this Alltrade.

        Идентификатор заявки  # noqa: E501

        :param orderno: The orderno of this Alltrade.  # noqa: E501
        :type: int
        """
    ...
    @property
    def symbol(self):
        """Gets the symbol of this Alltrade.  # noqa: E501

        Тикер (Код финансового инструмента). \"[N/A]\" используется если symbol не определен.  # noqa: E501

        :return: The symbol of this Alltrade.  # noqa: E501
        :rtype: str
        """
        return self._symbol
    ...
    def symbol(self, symbol):
        """Sets the symbol of this Alltrade.

        Тикер (Код финансового инструмента). \"[N/A]\" используется если symbol не определен.  # noqa: E501

        :param symbol: The symbol of this Alltrade.  # noqa: E501
        :type: str
        """
    ...
    @property
    def qty(self):
        """Gets the qty of this Alltrade.  # noqa: E501

        Количество  # noqa: E501

        :return: The qty of this Alltrade.  # noqa: E501
        :rtype: int
        """
        return self._qty
    ...
    @qty.setter
    def qty(self, qty):
        """Sets the qty of this Alltrade.

        Количество  # noqa: E501

        :param qty: The qty of this Alltrade.  # noqa: E501
        :type: int
        """
    ...
    @property
    def price(self):
        """Gets the price of this Alltrade.  # noqa: E501

        Цена  # noqa: E501

        :return: The price of this Alltrade.  # noqa: E501
        :rtype: float
        """
        return self._price
    ...
    def price(self, price):
        """Sets the price of this Alltrade.

        Цена  # noqa: E501

        :param price: The price of this Alltrade.  # noqa: E501
        :type: float
        """
    ...
    @property
    def time(self):
        """Gets the time of this Alltrade.  # noqa: E501

        Дата и время (UTC) закрытия заявки  # noqa: E501

        :return: The time of this Alltrade.  # noqa: E501
        :rtype: str
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this Alltrade.

        Дата и время (UTC) закрытия заявки  # noqa: E501

        :param time: The time of this Alltrade.  # noqa: E501
        :type: str
        """
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this Alltrade.  # noqa: E501

        Время (UTC) в формате Unix Time Milliseconds  # noqa: E501

        :return: The timestamp of this Alltrade.  # noqa: E501
        :rtype: int
        """
    ...
    def timestamp(self, timestamp):
        """Sets the timestamp of this Alltrade.

        Время (UTC) в формате Unix Time Milliseconds  # noqa: E501

        :param timestamp: The timestamp of this Alltrade.  # noqa: E501
        :type: int
        """
    ...
    @property
    def side(self):
        """Gets the side of this Alltrade.  # noqa: E501

        Направление агрессивной заявки. Поле может быть пустым  # noqa: E501

        :return: The side of this Alltrade.  # noqa: E501
        :rtype: str
        """
        return self._side
    ...
    @side.setter
    def side(self, side):
        """Sets the side of this Alltrade.

        Направление агрессивной заявки. Поле может быть пустым  # noqa: E501

        :param side: The side of this Alltrade.  # noqa: E501
        :type: str
        """
    ...
    @property
    def oi(self):
        """Gets the oi of this Alltrade.  # noqa: E501

        Открытый интерес (open interest). Если не поддерживается инстурментом - значение 0.  # noqa: E501

        :return: The oi of this Alltrade.  # noqa: E501
        :rtype: int
        """
        return self._oi
    ...
    @oi.setter
    def oi(self, oi):
        """Sets the oi of this Alltrade.

        Открытый интерес (open interest). Если не поддерживается инстурментом - значение 0.  # noqa: E501

        :param oi: The oi of this Alltrade.  # noqa: E501
        :type: int
        """
    ...
    @property
    def existing(self):
        """Gets the existing of this Alltrade.  # noqa: E501

        True - для данных из \"снепшота\", то есть из истории. False - для новых событий  # noqa: E501

        :return: The existing of this Alltrade.  # noqa: E501
        :rtype: bool
        """
    ...
    def existing(self, existing):
        """Sets the existing of this Alltrade.

        True - для данных из \"снепшота\", то есть из истории. False - для новых событий  # noqa: E501

        :param existing: The existing of this Alltrade.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Alltrade):
            return False

...
class History(object):
    ...
    def __init__(self, history=None, next=None, prev=None):  # noqa: E501
    ...
    @property
    def history(self):
        """Gets the history of this History.  # noqa: E501


        :return: The history of this History.  # noqa: E501
        :rtype: list[HistoryObject]
        """
        return self._history

    @history.setter
    def history(self, history):
        """Sets the history of this History.


        :param history: The history of this History.  # noqa: E501
        :type: list[HistoryObject]
        """
    ...
    @property
    def next(self):
        """Gets the next of this History.  # noqa: E501

        Время (UTC) начала следующей свечи  # noqa: E501

        :return: The next of this History.  # noqa: E501
        :rtype: int
        """
        return self._next
    ...
    @next.setter
    def next(self, next):
        """Sets the next of this History.

        Время (UTC) начала следующей свечи  # noqa: E501

        :param next: The next of this History.  # noqa: E501
        :type: int
        """
    ...
    @property
    def prev(self):
        """Gets the prev of this History.  # noqa: E501

        Время (UTC) начала предыдущей свечи  # noqa: E501

        :return: The prev of this History.  # noqa: E501
        :rtype: int
        """
        return self._prev
    ...
    @prev.setter
    def prev(self, prev):
        """Sets the prev of this History.

        Время (UTC) начала предыдущей свечи  # noqa: E501

        :param prev: The prev of this History.  # noqa: E501
        :type: int
        """

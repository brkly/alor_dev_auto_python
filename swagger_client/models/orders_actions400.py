...
class OrdersActions400(object):
    ...
    def __init__(self, message=None):  # noqa: E501
        """OrdersActions400 - a model defined in Swagger"""  # noqa: E501
        self._message = None
    ...
    @property
    def message(self):
        """Gets the message of this OrdersActions400.  # noqa: E501

        Вид ответа для случая отвергнутой заявки.  # noqa: E501

        :return: The message of this OrdersActions400.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this OrdersActions400.

        Вид ответа для случая отвергнутой заявки.  # noqa: E501

        :param message: The message of this OrdersActions400.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrdersActions400, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrdersActions400):
            return False

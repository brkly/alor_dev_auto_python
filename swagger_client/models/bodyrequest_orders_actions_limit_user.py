...
class BodyrequestOrdersActionsLimitUser(object):
    ...
    def __init__(self, account=None, portfolio=None):  # noqa: E501
        """BodyrequestOrdersActionsLimitUser - a model defined in Swagger"""  # noqa: E501
        self._account = None
    ...
    @property
    def account(self):
        """Gets the account of this BodyrequestOrdersActionsLimitUser.  # noqa: E501

        Идентификатор аккаунта пользователя  # noqa: E501

        :return: The account of this BodyrequestOrdersActionsLimitUser.  # noqa: E501
        :rtype: str
        """
    ...
    def account(self, account):
        """Sets the account of this BodyrequestOrdersActionsLimitUser.

        Идентификатор аккаунта пользователя  # noqa: E501

        :param account: The account of this BodyrequestOrdersActionsLimitUser.  # noqa: E501
        :type: str
        """
    ...
    @property
    def portfolio(self):
        """Gets the portfolio of this BodyrequestOrdersActionsLimitUser.  # noqa: E501

        Идентификатор клиентского портфеля  # noqa: E501

        :return: The portfolio of this BodyrequestOrdersActionsLimitUser.  # noqa: E501
        :rtype: str
        """
    ...
    def portfolio(self, portfolio):
        """Sets the portfolio of this BodyrequestOrdersActionsLimitUser.

        Идентификатор клиентского портфеля  # noqa: E501

        :param portfolio: The portfolio of this BodyrequestOrdersActionsLimitUser.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BodyrequestOrdersActionsLimitUser, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BodyrequestOrdersActionsLimitUser):
            return False

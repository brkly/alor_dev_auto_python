...
class PortfolioInfoInner(object):
    ...
    swagger_types = {
        'portfolio': 'str',
        'tks': 'str',
        'trade_servers_info': 'list[object]'
    }

    attribute_map = {
        'portfolio': 'portfolio',
        'tks': 'tks',
        'trade_servers_info': 'tradeServersInfo'
    }

    def __init__(self, portfolio=None, tks=None, trade_servers_info=None):  # noqa: E501
        """PortfolioInfoInner - a model defined in Swagger"""  # noqa: E501
        self._portfolio = None
        self._tks = None
        self._trade_servers_info = None
        self.discriminator = None
        if portfolio is not None:
            self.portfolio = portfolio
        if tks is not None:
            self.tks = tks
        if trade_servers_info is not None:
            self.trade_servers_info = trade_servers_info

    @property
    def portfolio(self):
        """Gets the portfolio of this PortfolioInfoInner.  # noqa: E501

        Идентификатор клиентского портфеля  # noqa: E501

        :return: The portfolio of this PortfolioInfoInner.  # noqa: E501
        :rtype: str
        """
    ...
    def portfolio(self, portfolio):
        """Sets the portfolio of this PortfolioInfoInner.

        Идентификатор клиентского портфеля  # noqa: E501

        :param portfolio: The portfolio of this PortfolioInfoInner.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tks(self):
        """Gets the tks of this PortfolioInfoInner.  # noqa: E501


        :return: The tks of this PortfolioInfoInner.  # noqa: E501
        :rtype: str
        """
        return self._tks
    ...
    @tks.setter
    def tks(self, tks):
        """Sets the tks of this PortfolioInfoInner.


        :param tks: The tks of this PortfolioInfoInner.  # noqa: E501
        :type: str
        """
    ...
    @property
    def trade_servers_info(self):
        """Gets the trade_servers_info of this PortfolioInfoInner.  # noqa: E501


        :return: The trade_servers_info of this PortfolioInfoInner.  # noqa: E501
        :rtype: list[object]
        """
        return self._trade_servers_info

    @trade_servers_info.setter
    def trade_servers_info(self, trade_servers_info):
        """Sets the trade_servers_info of this PortfolioInfoInner.


        :param trade_servers_info: The trade_servers_info of this PortfolioInfoInner.  # noqa: E501
        :type: list[object]
        """

        self._trade_servers_info = trade_servers_info
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PortfolioInfoInner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PortfolioInfoInner):
            return False
